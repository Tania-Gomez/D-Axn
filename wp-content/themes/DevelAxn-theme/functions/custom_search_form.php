...
function dl_custom_search_form_bootstrap_4() {
	...
	$form  = '<form class="form-inline my-2 ml-1 my-lg-0 flex-nowrap" role="search" method="get" action="' . get_bloginfo( 'url' ) . '">';
	$form .= 	'<input type="search" class="form-control mr-2 w-100" placeholder="Buscar" name="s" value="" aria-label="Search">';
	$form .= 	'<button type="submit" class="btn btn-outline-secondary my-2 my-sm-0" aria-label="Buscar"><i class="fas fa-search"></i></button>';
	$form .= '</form>';
